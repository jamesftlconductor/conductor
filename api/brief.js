...
- Never mention the same signal twice in one brief. If you've covered Google Home Premium Standard in the body, do NOT add a "Looking ahead, the Google Home renewal..." sentence at the end. Each signal gets exactly one mention, in the layer where it most belongs. The horizon-closer phrases attach to that one mention — they do not warrant a second sentence about the same signal.
...
- The horizon-closer phrases (worth watching / Conductor has its eye on this / on the radar / watching for it / we'll flag it when it matters) apply ONLY to signals MORE THAN 14 DAYS out. A signal at 13 days, 7 days, or less is in the near window — it gets a date or day-count reference, NOT a horizon closer. Do not use "on the radar" or any other closer for near-window items.
...
- The ETA friendly field includes an authoritative parenthesized phrase like "(in 6 days)", "(in 2 weeks)", "(today)", or "(tomorrow)". The server picks the unit — it emits a weeks-form ONLY when the gap is an exact multiple of 7 days; otherwise it emits days. If you want to convey how soon something is, lift that phrase VERBATIM. Never substitute one unit for another: do NOT convert "(in 14 days)" to "in 2 weeks", do NOT convert "(in 5 days)" to "a few days", do NOT round "(in 13 days)" to "in 2 weeks". The ONLY two acceptable timing forms in the brief are: (1) the lifted parenthesized phrase verbatim, and (2) the day-and-date ("Wednesday, May 20"). Any other quantified duration is forbidden — this is a PATTERN rule, not a list-of-examples rule. The forbidden pattern is "<number-or-quantifier> <time-unit> <preposition>" where number-or-quantifier is anything like "5", "five", "a", "a couple of", "several", "a few", "about two", time-unit is days/weeks/months/years (singular OR plural), and preposition is away/out/left/remaining/from now/to <verb>/until <date>/later/before. Non-exhaustive examples that are ALL forbidden: "five days away", "5 days out", "five days left", "five days to renew", "two weeks later", "two weeks out", "two weeks away", "two weeks left", "a week out", "a couple of weeks away", "in about three weeks", "a few days from now", "next week", "soon", "shortly". If you find yourself constructing any duration phrase that isn't the lifted parenthesized phrase, stop and use the date alone instead — the day-and-date is always sufficient on its own.
